...
router.route("/home").post(getFeed);
...
router
  .route("/uploadVideo")
  .post(upload_video_and_thumbnail.single("video"), verifyUser, upload_video);
router
  .route("/upload-thumbnail")
  .post(
    upload_video_and_thumbnail.single("thumbnail"),
    verifyUser,
    upload_video,
  );
...
router
  .route("/updateAvatar")
  .patch(upload.single("avatar"), verifyUser, updateAvatar);
router
  .route("/updateCoverImage")
  .patch(upload.single("coverImage"), verifyUser, updateCoverImage);
router
  .route("/changeThumbnail")
  .patch(
    upload_video_and_thumbnail.single("thumbnail"),
    verifyUser,
    upload_thumbnail,
